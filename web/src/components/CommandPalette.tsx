...
export function CommandPalette({ open, onOpenChange, onNavigate }: CommandPaletteProps) {
  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 z-[80] bg-foreground/40 backdrop-blur-[2px]" />
        <Dialog.Content
        ...
        >
          <Dialog.Title className="sr-only">Site command palette</Dialog.Title>
          <Command label="Site command palette" shouldFilter={false}>
